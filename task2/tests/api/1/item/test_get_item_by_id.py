...
negative_data_provider = DataProvider("api\\1\\item\\","get_negative_data.json")
positive_data_provider = DataProvider("api\\1\\item\\","get_positive_data.json")

def test_get_item_positive(api_client, created_item):
    """
    TC-1: Получение успешно созданного объявления.
...
def test_get_item_negative(api_client, test_data):
    """
    TC-2, TC-3: Негативные тесты для GET-запроса.
    """
